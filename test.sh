...
# 라라벨 public 폴더 때문에 /public 추가
sed -i "s|/var/www/localhost/htdocs|/var/www/html$DOCUMENT_ROOT/public|g" /etc/apache2/httpd.conf

# set SSL document root dir
# 라라벨 public 폴더 때문에 /public 추가
sed -i "s|DocumentRoot \".*\"|DocumentRoot \"/var/www/html$DOCUMENT_ROOT/public\"|g" /etc/apache2/conf.d/ssl.conf
